    ...
    <div className="flex items-center justify-between">
      ...
      {!isAtCurrentMonth && (
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-50 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg transition-colors"
        >
          Go to current month
        </button>
      )}
